...
if __name__ == "__main__":
    ...
    prob.driver.opt_settings['Print file'] = 'SNOPT_print_layout1_%s_dakota.out'%n
    prob.driver.opt_settings['Summary file'] = 'SNOPT_summary_layout1_%s_dakota.out'%n
    ...
    np.savetxt('layout_1_%s_XY_dakota.txt'%n, np.c_[prob['turbineX'], prob['turbineY']], header="turbineX, turbineY")
    ...
    jsonfile = open('layout_1_%s_dakota.json'%n,'w')
