...
if __name__ == "__main__":
    ...
    prob.driver.opt_settings['Print file'] = 'SNOPT_print_layout3_%s_dakota.out'%n
    prob.driver.opt_settings['Summary file'] = 'SNOPT_summary_layout3_%s_dakota.out'%n
    ...
    np.savetxt('layout_3_%s_XY_dakota.txt'%n, np.c_[prob['turbineX'], prob['turbineY']], header="turbineX, turbineY")
    ...
    jsonfile = open('layout_3_%s_dakota.json'%n,'w')
