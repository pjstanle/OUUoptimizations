...
import json
import sys
sys.path.insert(0,'/home/pjstanle/Documents/OUUoptimizations/src/')
...
if __name__ == "__main__":
    ...
    prob.driver.opt_settings['Print file'] = 'SNOPT_print_layout2_%s_dakota.out'%n
    prob.driver.opt_settings['Summary file'] = 'SNOPT_summary_layout2_%s_dakota.out'%n
    ...
    np.savetxt('layout_2_%s_XY_dakota.txt'%n, np.c_[prob['turbineX'], prob['turbineY']], header="turbineX, turbineY")
    ...
    jsonfile = open('layout_2_%s_dakota.json'%n,'w')
